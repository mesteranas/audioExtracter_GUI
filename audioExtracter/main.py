...
class main (qt.QMainWindow):
    def __init__(self):
        ...
        self.startConvertion=guiTools.QPushButton(_("extract audio"))
        self.startConvertion.clicked.connect(lambda:gui.ConvertGUI(self,self.path.toPlainText(),self.outputDir.toPlainText()).exec())
